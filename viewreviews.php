...
<head>
    ...
    <title>Reviews</title>
    <script src="responsivenabar.js"></script>
...
<div id="navbar">
        <nav class="navigationbar">
           <h1 class="logo"><a href="index1.html"><img src="img/country-club-06-m7V898ayM1uxBXM0.avif"></a></h1>
       <ul class="navi">
           <li><a class="active"href="index1.html">Home</a></li> 
            <li><a href="index1.html#ser">Services</a></li> <li><a href="about.html">About us</a></li>
             <li class="ctn"><a href="contactus.html">Contact us</a></li>
            <li><a href="login.html"><span class="material-symbols-outlined">
               tv_signin
               </span></a></li> 
       </ul>
       <img src="img/bar.png" alt="" class="menubutton">
        </nav> </div>
    <div class="login" >
     ...
     <div class="inputs">    
        ...
        <div class="stars">
          ...
          <p id="rating-value">You click on any rating and you can see all reviews have this rating</p>
  ...
  while($row=mysqli_fetch_assoc($result)){
    echo " <tr>
     <td>".$row['dbName']."</td>   <td>".$row['Review']."</td>
       <td> <a href='ratingdetails.php?Rating=" . $row['Rating'] . "' style='color: black; text-decoration: none;'>" . $row['Rating'] . "</a></td>
